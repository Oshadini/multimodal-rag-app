...
if uploaded_file is not None:
   ...
   # @st.cache_data(show_spinner=False)
    ...
    if st.button("Submit"): #if(question):
        ...
        retriever_multi_vector_img2=create_multi_vector_retriever(vectorstore,text_summaries,texts,table_summaries,tables,image_summaries,img_base64_list)

        docs = retriever_multi_vector_img2.get_relevant_documents(question, limit=1)
        st.write(docs)
        chain_multimodal_rag = multi_modal_rag_chain(retriever_multi_vector_img2)
